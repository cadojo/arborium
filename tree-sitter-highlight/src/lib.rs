...
/// Standard capture names recognized by arborium.
///
/// This comprehensive list includes names from:
/// - Standard tree-sitter highlighting
/// - nvim-treesitter
/// - Helix editor
///
/// All map to a fixed set of theme slots via arborium-theme.
