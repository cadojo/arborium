...
pub const HIGHLIGHTS_QUERY: &str = include_str!("../../../tree-sitter-vue/queries/highlights.scm");

/// The injections query for vue.
pub const INJECTIONS_QUERY: &str = include_str!("../../../tree-sitter-vue/queries/injections.scm");
